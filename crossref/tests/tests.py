...
from crossref.models import Publication
from crossref.templatetags.crossref_tags import tex_parse
...
class Tests(TestCase):
	...
	def test_publications(self):
		...
		self.assertEqual(self.client.get('/crossref/').status_code, 200)
		self.assertEqual(self.client.get('/crossref/?plain').status_code, 200)
		self.assertEqual(self.client.get('/crossref/?bibtex').status_code, 200)
		self.assertEqual(self.client.get('/crossref/?mods').status_code, 200)
		self.assertEqual(self.client.get('/crossref/?ris').status_code, 200)
		self.assertEqual(self.client.get('/crossref/?rss').status_code, 200)
		self.assertEqual(self.client.get('/crossref/1/').status_code, 200)
		self.assertEqual(self.client.get('/crossref/1/?plain').status_code, 200)
		self.assertEqual(self.client.get('/crossref/1/?bibtex').status_code, 200)
		self.assertEqual(self.client.get('/crossref/1/?mods').status_code, 200)
		self.assertEqual(self.client.get('/crossref/1/?ris').status_code, 200)
		response = self.client.get('/crossref/j.-p.+lies/')
		self.assertEqual(response.status_code, 200)
		self.assertGreater(len(response.context['publications']), 0)
		self.assertEqual(self.client.get('/crossref/j.-p.+lies/?plain').status_code, 200)
		self.assertEqual(self.client.get('/crossref/j.-p.+lies/?bibtex').status_code, 200)
		self.assertEqual(self.client.get('/crossref/j.-p.+lies/?mods').status_code, 200)
		self.assertEqual(self.client.get('/crossref/j.-p.+lies/?ris').status_code, 200)
		self.assertEqual(self.client.get('/crossref/j.-p.+lies/?rss').status_code, 200)
		self.assertEqual(self.client.get('/crossref/tag/noise+correlations/').status_code, 200)
		self.assertEqual(self.client.get('/crossref/list/highlights/').status_code, 200)
		self.assertEqual(self.client.get('/crossref/year/2011/').status_code, 200)
		self.assertEqual(self.client.get('/crossref/year/2011/?plain').status_code, 200)
		self.assertEqual(self.client.get('/crossref/year/2011/?bibtex').status_code, 200)
		...
		response = self.client.get('/crossref/c.+common/')
	...
	def test_bibtex_import(self):
		...
		response = self.client.post('/admin/crossref/publication/import_bibtex/',
	...
	def test_unapi(self):
		self.assertEqual(self.client.get('/crossref/unapi/').status_code, 200)
		self.assertEqual(self.client.get('/crossref/unapi/?id=1').status_code, 200)
		self.assertEqual(self.client.get('/crossref/unapi/?id=1&format=mods').status_code, 200)
		self.assertEqual(self.client.get('/crossref/unapi/?id=1&format=bibtex').status_code, 200)
		self.assertEqual(self.client.get('/crossref/unapi/?id=1&format=ris').status_code, 200)
		self.assertEqual(self.client.get('/crossref/unapi/?id=99999&format=bibtex').status_code, 404)
		self.assertEqual(self.client.get('/crossref/unapi/?id=1&format=foobar').status_code, 406)
	...
	def test_admin(self):
		...
		self.assertEqual(self.client.get('/crossref/').status_code, 200)
		self.assertEqual(self.client.get('/admin/crossref/type/6/move-up/', follow=True).status_code, 200)
		self.assertEqual(self.client.get('/admin/crossref/type/6/move-down/', follow=True).status_code, 200)
