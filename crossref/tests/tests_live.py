...
class LiveTests(LiveServerTestCase):
	...
	def test_import_bibtex(self):
		...
		self.selenium.get('{0}{1}'.format(self.live_server_url, '/admin/crossref/publication/import_bibtex/'))
	...
	def test_import_bibtex_button(self):
		...
		self.selenium.get('{0}{1}'.format(self.live_server_url, '/admin/crossref/publication/'))
